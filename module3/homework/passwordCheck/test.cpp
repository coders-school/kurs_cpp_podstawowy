...
TEST(getErrorMessageTests, returnsErrorCodeAsString)
{
    ...
    EXPECT_EQ(getErrorMessage(ErrorCode::PasswordNeedsAtLeastNineCharacters), "PasswordNeedsAtLeastNineCharacters");
    EXPECT_EQ(getErrorMessage(ErrorCode::PasswordNeedsAtLeastOneNumber), "PasswordNeedsAtLeastOneNumber");
