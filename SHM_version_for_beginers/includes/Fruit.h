...
public:
    Fruit(size_t amount, const std::string& name, size_t base_price, size_t expiry_date, Time* time);
    Fruit(size_t amount, const std::string& name, size_t base_price, size_t expiry_date, size_t time_elapsed, Time* time);
